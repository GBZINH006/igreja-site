...
export const FichaCadastro = () => {
    ...
    if (enviado) {
        return (
            <div className="flex align-items-center justify-content-center h-screen bg-gray-100 p-4">
                <Card className="text-center surface-glass soft-card w-full md:w-30rem border-round-xl">
    ...
    return (
        <div className="min-h-screen p-4 page-fade-in">
            <div className="max-w-7xl mx-auto">
                <div className="flex align-items-center mb-4 surface-glass p-3 border-round-xl">
                ...
                <Card className="p-fluid surface-glass soft-card">
