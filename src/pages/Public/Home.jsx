    ...
    return (
        <div className="min-h-screen font-sans page-fade-in">
            ...
            <div
                ...
                style={{
                    background:
                        "linear-gradient(rgba(0,0,0,0.5), rgba(0,0,0,0.7)), url('src/pages/Public/Igreja1.jpg')",
            ...
            >
                <div className="hero-content text-center p-4">
                    ...
                    <span className="hero-badge">
                        <i className="pi pi-star-fill"></i> Comunidade, Fé e Serviço
                    </span>
                    ...
                    <div className="flex justify-content-center">
                        <Button
                            ...
                            onClick={() => navigate('/FichaCadastro')}
                        />
                    </div>
            ...
            <div className="relative px-4 md:px-8 mt-6 z-1">
                <div className="grid justify-content-center">
                    ...
                    <div className="col-12 md:col-4 lg:col-3">
                        ...
                        <Card
                            className="text-center soft-card surface-glass border-none"
